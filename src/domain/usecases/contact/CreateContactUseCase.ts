import { IContactResponseDTO, ICreateContactRequestDTO } from "@domain/dtos/contact";
...
export interface ICreateContactUseCase {
   ...
   */
  execute(request: ICreateContactRequestDTO): Promise<UseCaseResponse<IContactResponseDTO>>;
}
